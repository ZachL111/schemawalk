...
schemawalk is a Ruby project for databases. It focuses on this technical goal: Plan reversible migrations and flag destructive schema operations.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 150, risk penalty 7, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
