"""Regression checks for the schemawalk casebook."""
...
from casebook.harness import assert_expected, schemawalk_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(schemawalk_summary(), assert_expected())
